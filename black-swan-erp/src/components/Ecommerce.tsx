...
const products: Product[] = [
    { id: '1', name: 'Premium Surgeon Gown', price: 45, image: 'https://images.unsplash.com/photo-1584036561566-b45238f2e121?auto=format&fit=crop&q=80&w=400', rating: 4.8, sizes: [] },
    { id: '2', name: 'Nurse Scrub Set (Teal)', price: 30, image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=400', rating: 4.5, sizes: [] },
    { id: '3', name: 'Lab Coat (Anti-Microbial)', price: 55, image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=400', rating: 4.9, sizes: [] },
    { id: '4', name: 'Medical Crocs', price: 25, image: 'https://images.unsplash.com/photo-1603400521630-9f2de124b33b?auto=format&fit=crop&q=80&w=400', rating: 4.2, sizes: [] },
    { id: '5', name: 'Surgical Cap', price: 12, image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&q=80&w=400', rating: 4.7, sizes: [] },
    { id: '6', name: 'Patient Gown', price: 18, image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=400', rating: 4.0, sizes: [] },
];
            ...
            <div key={product.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        <span className="text-2xl font-bold text-teal-600">{product.price} {t('currency')}</span>
                        <button 
                      ...
                      cart.map(item => (
                          <div key={item.id} className="flex gap-4 p-4 bg-white border border-slate-100 rounded-xl shadow-sm">
                              ...
                              <div className="flex-1">
                                  ...
                                  <p className="text-teal-600 font-bold mb-3">{(item.price || 0) * item.quantity} {t('currency')}</p>
