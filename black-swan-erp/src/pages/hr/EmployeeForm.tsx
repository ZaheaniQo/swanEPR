                                ...
                                <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div className="flex flex-col gap-2">
                                                    <label htmlFor="avatarUpload" className="text-sm text-text">الصورة/الأفاتار</label>
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <label htmlFor="avatarUpload" className="cursor-pointer px-3 py-2 rounded border bg-secondary/50 flex items-center gap-2 text-sm">
                                                            <Upload size={14}/> رفع
                                                        </label>
                                                        <input
                                                          id="avatarUpload"
