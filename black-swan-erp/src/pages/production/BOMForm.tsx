        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <Card>
                <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    />
                    <div>
                        <label htmlFor="bomOutputProduct" className="block text-sm font-medium text-slate-700 mb-1">Output Product</label>
                        <select 
                            id="bomOutputProduct"
                        ...
                        {items.map((item, index) => (
                            <div key={index} className="flex gap-4 items-end bg-slate-50 p-4 rounded-lg border border-slate-200">
                                <div className="flex-1">
                                    <label htmlFor={`component-${index}`} className="block text-xs font-medium text-slate-500 mb-1">Component</label>
                                    <select 
                                        id={`component-${index}`}
                                ...
                                <div className="w-32">
                                    <label htmlFor={`quantity-${index}`} className="block text-xs font-medium text-slate-500 mb-1">Quantity</label>
                                    <Input 
                                        id={`quantity-${index}`}
                                        type="number" 
                                        value={item.quantity} 
                                ...
                                <div className="w-32">
                                    <label htmlFor={`waste-${index}`} className="block text-xs font-medium text-slate-500 mb-1">Wastage %</label>
                                    <Input 
                                        id={`waste-${index}`}
                                        type="number" 
