            ...
            <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        />
                        <div>
                            <label htmlFor="woBom" className="block text-sm font-medium text-slate-700 mb-1">Bill of Materials (BOM)</label>
                            <select 
                                id="woBom"
                        ...
                        <div>
                            <label htmlFor="woWarehouse" className="block text-sm font-medium text-slate-700 mb-1">Target Warehouse</label>
                            <select 
                                id="woWarehouse"
                                className="w-full p-2 border rounded-md"
                        ...
                        />
                        <div>
                            <label htmlFor="wo-status" className="block text-sm font-medium text-slate-700 mb-1">Status</label>
                            <select 
                                id="wo-status"
                                className="w-full p-2 border rounded-md"
                    ...
                    <div>
                        <label htmlFor="woNotes" className="block text-sm font-medium text-slate-700 mb-1">Notes</label>
                        <textarea 
                            id="woNotes"
