...
import { Project, ProjectStageStatus, Role, Disbursement } from '../types';
            ...
            <div key={project.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/50">
                    ...
                    <div className="flex items-center gap-6">
                         <div className="text-right">
                             <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold">Project Cost</p>
                             <p className="text-lg font-bold text-red-600">-{totalProjectCost.toLocaleString()} SAR</p>
                         </div>
                        <div className="text-right">
                ...
                {projectExpenses.length > 0 && (
                    <div className="p-6 border-t border-slate-100 bg-slate-50">
                        <h4 className="text-sm font-bold text-slate-700 mb-3 flex items-center gap-2"><TrendingDown size={16}/> Project Expenses</h4>
