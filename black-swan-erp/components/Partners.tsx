        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
                <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-100">
                    ...
                    <p className="text-4xl font-bold text-emerald-600">${stats.netProfit.toLocaleString()}</p>
                     ...
                     <div className="space-y-4">
                         <div>
                             <div className="flex justify-between text-sm mb-1">
                                 ...
                                 <span className="font-bold">${(stats.netProfit * 0.4).toLocaleString()}</span>
                             </div>
                         ...
                         <div>
                             <div className="flex justify-between text-sm mb-1">
                                 ...
                                 <span className="font-bold">${(stats.netProfit * 0.3).toLocaleString()}</span>
                             </div>
                             <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
